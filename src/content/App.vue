<template>
  ...
  >
    ...
    >
      ...
      <el-form-item>
        <el-button class="btn-container" type="info">截取首屏作为网站图片</el-button>
        <!-- <el-button class="btn-container" type="info" @click="getPicture()">截取首屏作为网站图片</el-button> -->
  ...
  methods: {
    ...
    putb64(pic) {
      ...
      xhr.setRequestHeader(
        "Authorization",
        "vNBgV03wzBamr-cuCPnzR9YCbRnDnG8q4_Zu09W1:aeD8jxzBQVzfeGh7SmEL70SuJJA=:eyJzY29wZSI6InFpdWZlaWhvbmciLCJkZWFkbGluZSI6MTU3MTgxODI0NX0="
      );
      xhr.send(pic);
    },
    base64encode(str) {
    ...
    genUpToken(accessKey, secretKey, putPolicy) {
      ...
      var upload_token =
        accessKey + ":" + this.safe64(encoded_signed) + ":" + encoded;
